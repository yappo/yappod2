...
int YAP_V2_prepare_main(int argc,char **argv){
  const char *config_path=NULL,*input_path=NULL,*output_path=NULL,*format="ndjson";FILE *input=NULL,*output=NULL;char *line=NULL;size_t capacity=0U;ssize_t length;YAP_V2_CONFIG config;char error[256];int i,result=EXIT_FAILURE;
