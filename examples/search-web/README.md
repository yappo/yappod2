...
| `core_port` | 整数 | 1〜65535 | search-webでは`18401`。Yappod2サーバーではなし | Yappod2サーバーを起動する場合は必須 | frontからcoreへ検索や更新を依頼する専用ポートです。HTTPではありません。 |
...
| `request_timeout_ms` | 整数 | 1〜60000 | `5000` | 任意 | coreとfrontが接続後のソケット送受信へ設定する期限です。 |
