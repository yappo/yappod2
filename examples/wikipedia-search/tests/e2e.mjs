...
const webUrl = process.env.WIKIPEDIA_E2E_WEB_URL;
const yappodUrl = process.env.WIKIPEDIA_E2E_YAPPOD_URL;
const writeToken = process.env.YAPPOD_WRITE_TOKEN;
if (!webUrl || !yappodUrl || !writeToken) throw new Error("E2E URLs and write token are required");
