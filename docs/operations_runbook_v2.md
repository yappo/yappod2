...
yappod_core -l /srv/yappod/index -p 10086
yappod_front -l /srv/yappod/index -s 127.0.0.1 -p 10080 -P 10086
```
...
| `GET /healthz` | `/health/live`の互換alias | 既存probeの継続利用 |
...
latency閾値は本番corpusとhardwareでTask 23の負荷baselineを採取してから固定します。
