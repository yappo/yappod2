...
> **現代検索対応の現在地:** v2 index契約、BM25、manifest、JSON response、passage lookup、exact vector、RRFは独立した基礎部品として存在しますが、索引作成からvector/hybrid/RAG検索までの製品経路にはまだ統合されていません。完成済み範囲、残作業、最終受入条件は[現代検索基盤の完成契約](docs/modern_search_completion_contract.md)を正本とします。
